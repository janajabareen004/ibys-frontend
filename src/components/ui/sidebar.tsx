...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      className={cn(
        "h-10 w-10 shrink-0 rounded-full border-border/80 bg-background shadow-sm",
        "transition-all duration-200 ease-out",
        "hover:scale-105 hover:bg-accent/80 hover:text-accent-foreground hover:shadow-md",
